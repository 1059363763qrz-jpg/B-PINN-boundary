...
HARD_THETA_LIST = [2,4,5,7]
TRAIN_THETA_LIST = HARD_THETA_LIST
ALL_THETA_LIST = HARD_THETA_LIST
...
def main_v7_4_quantile_calibration_only():
    print('[v7.4-qcal-only] start',flush=True)
    apply_v7_1_runtime_config()
    global ALL_THETA_LIST, TRAIN_THETA_LIST
    ALL_THETA_LIST=HARD_THETA_LIST; TRAIN_THETA_LIST=HARD_THETA_LIST
    ...
    for theta_idx in HARD_THETA_LIST:
        print(f'[v7.4-qcal-only] train theta={theta_idx:02d}',flush=True)
        train_single_theta_v7style_model_with_qcal(case,data_dict,theta_idx)
    run_qcal_only_targeted_mc2500_eval(case,data_dict)
    print('[v7.4-qcal-only] done',flush=True)
