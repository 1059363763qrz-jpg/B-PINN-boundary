...
caches, plots, and a visualization manifest.
"""
...
def main():
    ...
    manifest_csv = _abs_path(SELECTED_FLEX_DOMAIN_OUT_DIR) / "visualization_manifest_v7_4_6_1_selected_seed_flex_domain.csv"
