...
实验建议：
1) 正式大规模实验前先设置 SMOKE_TEST=True 做小样本连通性检查；
2) SMOKE_TEST 通过后再切回大规模配置运行正式训练。
"""
...
# 正式大规模实验前建议先设置：
# SMOKE_TEST = True
# 该模式下：NUM_SCENARIOS=2, MC_PER_SCENARIO=3, N_THETA=4, EPOCHS=2, RUN_MULTI_TEST=False
