...
def apply_v7_1_runtime_config():
    ...
    if SMOKE_TEST:
        ...
        NUM_SCENARIOS=800; MC_PER_SCENARIO=30; N_THETA=12; EPOCHS=340
...
def main_v7_1_no_pcc_pipeline():
    print("[v7.1-no-pcc] start", flush=True)
    apply_v7_1_runtime_config()
    assert_no_old_model_or_cache_paths()
    ...
    if BUILD_NEW_DATASET:
        ...
        print('[dataset-new-policy]',flush=True); print(f'DATASET_CACHE_TAG = {DATASET_CACHE_TAG}',flush=True); print(f'line_limit_mode = {case.line_limit_mode}',flush=True); print(f'pcc_branch_indices = {case.pcc_branch_indices.tolist()}',flush=True); print(f'USE_EXPLICIT_PCC_LIMITS = {case.use_explicit_pcc_limits}',flush=True); print('active_records_match = True', flush=True); print('max_abs_h_res = n/a', flush=True); print('theta3_h_atom_mass_tol1e-4 = n/a', flush=True)
    else:
        XMU,XREAL,THETA_FEAT,YH,YP0,YQ0,YPG,YQG,active_records,all_names=get_or_build_flex_dataset_cache(case)
